...
class HeadlineMovie extends StatefulWidget {
  final Movie movie;

  HeadlineMovie({this.movie});

  @override
  _HeadlineMovieState createState() => _HeadlineMovieState();
}

class _HeadlineMovieState extends State<HeadlineMovie> {
  @override
